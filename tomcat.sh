...
https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.105/bin/apache-tomcat-9.0.105.tar.gz
...
sed -i '58  a\<user username="tomcat" password="Ashu@2612" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.105/conf/tomcat-users.xml
